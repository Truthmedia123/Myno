...
const JAPANESE_A2 = {
    ...
    "phonemeDetails": [
        {
            "phonemeKey": "Pitch accent patterns",
            "difficulty": "medium",
            "examples": [
                "はし (chopsticks) vs はし (bridge)",
                "あめ (rain) vs あめ (candy)"
            ]
        }
    ],
