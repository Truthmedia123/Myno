/**
 * Japanese B1 syllabus
 * CEFR Level: B1 (Intermediate)
 * @module curriculum/japanese/B1
 */
...
const JAPANESE_B1 = {
    ...
    phonemeDetails: [
        {
            key: "Pitch accent patterns",
            description: "Description for Pitch accent patterns",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        },
        {
            key: "'r' sound (between r and l)",
            description: "Description for 'r' sound (between r and l)",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        }
