...
const KOREAN_B1 = {
    ...
    phonemeDetails: [
        {
            key: "Aspirated consonants (ㅍ/ㅌ/ㅋ/ㅊ)",
            description: "Description for Aspirated consonants (ㅍ/ㅌ/ㅋ/ㅊ)",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        },
        {
            key: "Tense consonants (ㅃ/ㄸ/ㄲ/ㅆ/ㅉ)",
            description: "Description for Tense consonants (ㅃ/ㄸ/ㄲ/ㅆ/ㅉ)",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        }
