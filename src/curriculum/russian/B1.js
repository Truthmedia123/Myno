...
const RUSSIAN_B1 = {
    ...
    phonemeDetails: [
        {
            key: "Palatalization (soft signs)",
            description: "Description for Palatalization (soft signs)",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        },
        {
            key: "vowel reduction",
            description: "Description for vowel reduction",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        }
