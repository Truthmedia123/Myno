...
const RUSSIAN_A2 = {
    ...
    "phonemeDetails": [
        {
            "phonemeKey": "Soft consonants (palatalization)",
            "difficulty": "medium",
            "examples": [
                "мел (chalk) vs мель (shoal)",
                "угол (corner) vs уголь (coal)"
            ]
        },
        {
            "phonemeKey": "Vowel reduction",
            "difficulty": "medium",
            "examples": [
                "молоко",
                "хорошо",
