...
const TURKISH_B1 = {
    ...
    phonemeDetails: [
        {
            key: "soft ğ (yumuşak ge)",
            description: "Description for soft ğ (yumuşak ge)",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        },
        {
            key: "dotted/dotless i",
            description: "Description for dotted/dotless i",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        }
