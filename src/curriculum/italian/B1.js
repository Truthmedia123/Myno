...
const ITALIAN_B1 = {
    ...
    phonemeDetails: [
        {
            key: "'gli' sound",
            description: "Description for 'gli' sound",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        },
        {
            key: "Open/Closed vowels",
            description: "Description for Open/Closed vowels",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        }
