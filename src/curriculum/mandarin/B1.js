/**
 * Mandarin B1 syllabus
 * CEFR Level: B1 (Intermediate)
 * @module curriculum/mandarin/B1
 */
...
const MANDARIN_B1 = {
    ...
    phonemeDetails: [
        {
            key: "Tones (4 tones + neutral)",
            description: "Description for Tones (4 tones + neutral)",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        },
        {
            key: "Retroflex finals (-r)",
            description: "Description for Retroflex finals (-r)",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        }
