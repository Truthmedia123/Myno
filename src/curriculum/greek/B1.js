...
const GREEK_B1 = {
    ...
    phonemeDetails: [
        {
            key: "Greek consonants (γ/χ/ξ/ψ)",
            description: "Description for Greek consonants (γ/χ/ξ/ψ)",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        },
        {
            key: "double consonants",
            description: "Description for double consonants",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        }
