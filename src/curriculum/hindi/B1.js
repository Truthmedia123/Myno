...
const HINDI_B1 = {
    ...
    phonemeDetails: [
        {
            key: "Retroflex consonants (ट/ड/ण)",
            description: "Description for Retroflex consonants (ट/ड/ण)",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        },
        {
            key: "Aspirated sounds (ख/घ/छ/झ)",
            description: "Description for Aspirated sounds (ख/घ/छ/झ)",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        }
