...
const SWEDISH_A2 = {
    ...
    "phonemeDetails": [
        {
            "phonemeKey": "pitch accent (accent 1/2)",
            "difficulty": "medium",
            "examples": [
                "anden (duck) vs anden (spirit)",
                "tomten (plot) vs tomten (Santa)"
            ]
        },
        {
            "phonemeKey": "sj sound (retroflex fricative)",
            "difficulty": "medium",
            "examples": [
                "sjuk",
                "skjorta",
