...
const SWEDISH_A1 = {
    ...
    grammar: ['gender_en_ett', 'v2_word_order', 'present_tense', 'definite_suffix'],
    ...
    phonemes: ['pitch accent (accent 1/2)', 'sj sound (retroflex fricative)', 'vowel length'],
