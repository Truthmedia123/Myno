...
const ARABIC_B1 = {
    ...
    phonemeDetails: [
        {
            key: "Emphatic consonants (ص/ض/ط/ظ)",
            description: "Description for Emphatic consonants (ص/ض/ط/ظ)",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        },
        {
            key: "Guttural sounds (ع/غ/خ/ح)",
            description: "Description for Guttural sounds (ع/غ/خ/ح)",
            examples: ["Example 1", "Example 2", "Example 3"],
            difficulty: "medium",
            commonErrors: ["Common error 1", "Common error 2"]
        }
